...
from learning.views import BootcampListView, ClassListView, RetrieveBootcampView, RetrieveClassView, CreatBootcamp, CreatClass, AddAssignmentToClassView, AddLessonSerilizer
urlpatterns = [
    path('add_assignmet_to_class', AddAssignmentToClassView.as_view()),
    path('add_bootcamp', CreatBootcamp.as_view(), AddLessonSerilizer.as_view()),
